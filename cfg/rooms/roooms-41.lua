Config.NewRoom({
	Id = 4001,
	Name = "The Hills",
	Desc = [[   You are on a path leading north, small hills surround you.
...
Config.NewRoom({
	Id = 4002,
	Name = "The Hills",
	Desc = [[   You are on a small path leading north, dark threatening hills
...
Config.NewRoom({
	...
	Desc = [[   The path stops here, to the north is a single mountain and around
...
Config.NewRoom({
	Id = 4011,
	Name = "The Cave",
	Desc = [[   You are standing in a small cave, about fifteen feet across at
...
Config.NewRoom({
	Id = 4012,
	Name = "The Tunnel",
	Desc = [[   You force your way into a narrow tunnel, aided by the wet walls
...
Config.NewRoom({
	Id = 4013,
	Name = "The Tunnel",
	Desc = [[   You find yourself at a turn in this narrow tunnel.  The tunnel
...
Config.NewRoom({
	Id = 4014,
	Name = "The Tunnel",
	Desc = [[   Standing in the middle of the dusty floor of this tunnel, you can
...
Config.NewRoom({
	Id = 4015,
	Name = "The Tunnel",
	Desc = [[   You find yourself at a small intersection of sorts in this tunnel.
...
Config.NewRoom({
	Id = 4016,
	Name = "The Tunnel",
	Desc = [[   You clamber on through this narrow tunnel.  The walls are damp
...
Config.NewRoom({
	Id = 4017,
	Name = "The Large Cave",
	Desc = [[   You find yourself in a fairly large cave.  Large enough that the
...
Config.NewRoom({
	Id = 4018,
	Name = "The Large Cave",
	Desc = [[   You move along the cave to the west end of it and find that there
...
Config.NewRoom({
	Id = 4019,
	Name = "The Cave",
	Desc = [[   You find yourself at the southern end of a cave as it begins
...
Config.NewRoom({
	Id = 4020,
	Name = "The Tunnel",
	Desc = [[   You stand in the middle of a fairly wide passageway that leads
...
Config.NewRoom({
	Id = 4021,
	Name = "The Hole",
	Desc = [[   You are standing in a small alcove off the main tunnel.  There is
...
Config.NewRoom({
	Id = 4022,
	Name = "The Hole",
	Desc = [[   As you stand at the end of this tunnel, you notice a large hole
...
Config.NewRoom({
	...
	Desc = [[   You are standing in the middle of a damp tunnel.  The moisture
...
Config.NewRoom({
	Id = 4024,
	Name = "The Large Cave",
	Desc = [[   You are in the western part of the large cave, to the east you can
...
Config.NewRoom({
	Id = 4025,
	Name = "The Damp Tunnel",
	Desc = [[   The tunnel you are in now is very humid, and the air seems to almost
...
Config.NewRoom({
	Id = 4026,
	Name = "The Cave",
	Desc = [[   You find yourself standing in the northern end of a reasonably
...
Config.NewRoom({
	...
	Desc = [[   You find yourself standing in the midst of an intersection
...
Config.NewRoom({
	Id = 4028,
	Name = "The Tunnel",
	Desc = [[   You find yourself at an elbow turn in the tunnel as it turns to the
...
Config.NewRoom({
	...
	Desc = [[   You are in a fairly small north-south leading tunnel.  There
...
Config.NewRoom({
	Id = 4030,
	Name = "The Cave",
	Desc = [[   You are in a cave that is filled with fresh air, you sense the
...
Config.NewRoom({
	Id = 4031,
	Name = "The Light Cave",
	Desc = [[   You are in a light cave, through a hole large above you, you
...
Config.NewRoom({
	Id = 4032,
	Name = "The Valley",
	Desc = [[   You are in a small valley, surrounded by hills and a mountain to 
...
Config.NewRoom({
	Id = 4033,
	Name = "The Foothills",
	Desc = [[   You are on a winding path that leads through the foothills on the
...
Config.NewRoom({
	...
	Desc = [[   You stand at a point by a small path that splits off here.  The
...
Config.NewRoom({
	...
	Desc = [[   The grass here is unusually high.  You notice several areas where
...
Config.NewRoom({
	...
	Desc = [[   You find yourself standing at the northern edge of the foothills
...
Config.NewRoom({
	Id = 4037,
	Name = "The Plains",
	Desc = [[   You are in the plains.  The path leads to the south.  As you look
...
Config.NewRoom({
	...
	Desc = [[   You stand on a path that leads through the foothills in an
...
Config.NewRoom({
	...
	Desc = [[   You find yourself standing at the bottom of a large mountain in
...
Config.NewRoom({
	...
	Desc = [[   You stand partway up the mountainside on a narrow yet well worn
...
Config.NewRoom({
	...
	Desc = [[   You find yourself at what is essentially the summit of this mountain.
...
Config.NewRoom({
	Id = 4042,
	Name = "The Lion's Den",
	Desc = [[   Following the gouge down to the cave entrance, you clamber through
...
Config.NewRoom({
	...
	Desc = [[   You continue to move through the foothills and notice that off in
...
Config.NewRoom({
	...
	Desc = [[   You stand in a large tunnel, much larger than it seemed from
...
Config.NewRoom({
	...
	Desc = [[   You find yourself inside a rather large cavern.  The ceiling stands
...
Config.NewRoom({
	...
	Desc = [[   This trail leads up a steep hill to a point where it levels out as
...
Config.NewRoom({
	...
	Desc = [[   The trail between the mountains seems almost endless as you continue
...
Config.NewRoom({
	Id = 4048,
	Name = "The Foothills",
	Desc = [[   After a long trek, you find yourself in the foothills again.  You spot
...
Config.NewRoom({
	Id = 4049,
	Name = "The Foothills",
	Desc = [[   A short trek through the foothills and you find yourself facing a
...
Config.NewRoom({
	Id = 4050,
	Name = "The Foothills",
	Desc = [[   You are at a point on the trail where it turns slowly from an
...
Config.NewRoom({
	Id = 4051,
	Name = "The Tunnel",
	Desc = [[   You are at a bend in the tunnel here.  It turns from an eastwards
...
Config.NewRoom({
	Id = 4052,
	Name = "The Tunnel",
	Desc = [[   Standing in this part of the tunnel, you notice that not only does
...
Config.NewRoom({
	Id = 4053,
	Name = "The Tunnel",
	Desc = [[   Continuing along the tunnel, you find that the floor has begun
...
Config.NewRoom({
	Id = 4054,
	Name = "The Tunnel",
	Desc = [[   You continue along the tunnel to find yourself at a right
...
Config.NewRoom({
	Id = 4055,
	Name = "The Light Cave",
	Desc = [[   The cave you stand in now is lit by an eerie flickering light,
...
Config.NewRoom({
	Id = 4056,
	Name = "The Maze",
	Desc = [[   You stand in yet another small and damp tunnel.  The ceiling hangs
...
Config.NewRoom({
	Id = 4060,
	Name = "The Tunnel",
	Desc = [[   You are standing in a tunnel deep inside the heart of Mount Moria.  A
...
Config.NewRoom({
	Id = 4061,
	Name = "The Tunnel",
	Desc = [[   You stand in a section of this small tunnel which seems to be
...
Config.NewRoom({
	Id = 4065,
	Name = "The Tunnel",
	Desc = [[   You stand in a small chamber beneath the earth.  The chamber
...
Config.NewRoom({
	Id = 4069,
	Name = "The Large Cave",
	Desc = [[   You find yourself in what is perhaps the largest cave you
...
Config.NewRoom({
	Id = 4073,
	Name = "The Tunnel",
	Desc = [[   You stand in a narrow tunnel.  It makes a turn from east to south
...
Config.NewRoom({
	...
	Desc = [[   The tunnel comes to a sudden halt here.  How very bizarre.  The
...
Config.NewRoom({
	Id = 4075,
	Name = "The Hole",
	Desc = [[   You are at a small hole in the floor.  Alas, you can only leave
...
Config.NewRoom({
	...
	Desc = [[   Standing in this copse of trees gives you an eerie feeling.  Off to
...
Config.NewRoom({
	...
	Desc = [[   You find yourself on a mountain trail twisting down towards a small
...
Config.NewRoom({
	...
	Desc = [[   This valley seems to be a complete waste of a climb down the
...
Config.NewRoom({
	Id = 4079,
	Name = "In The Hidden Valley",
	Desc = [[   This small valley is hidden away in the shadow of the large
...
Config.NewRoom({
	Id = 4101,
	Name = "The Tunnel",
	Desc = [[   As you continue along this tunnel which heads deeper and deeper into
...
Config.NewRoom({
	...
	Desc = [[   The tunnel seems to be slightly sloped here as it continues in its
...
Config.NewRoom({
	Id = 4103,
	Name = "The Long Tunnel",
	Desc = [[   As you travel along this long tunnel, you begin to wonder just
...
Config.NewRoom({
	Id = 4104,
	Name = "The Long Tunnel",
	Desc = [[   You are standing in a long east-west tunnel.  It is not all that
...
Config.NewRoom({
	Id = 4105,
	Name = "The Long Tunnel",
	Desc = [[   You find yourself in a small bulbous cavern ending.  The somewhat
...
Config.NewRoom({
	...
	Desc = [[   You are standing in what appears to be the north-east corner of
...
Config.NewRoom({
	Id = 4107,
	Name = "The Golden Cave",
	Desc = [[   You are standing in what appears to be the north-west corner of
this large cavern.  The cave is lit by the eerie, soft, golden light
which looks to be emanating from the walls themselves.  The cave
...
Config.NewRoom({
	Id = 4108,
	Name = "The Passage",
	Desc = [[   You are standing at the elbow turn of a small passageway.  It turns
...
Config.NewRoom({
	Id = 4109,
	Name = "The Golden Cave",
	Desc = [[   You are standing in what appears to be the south-east corner of
this large cavern.  The cave is lit by the eerie, soft, golden light
which looks to be emanating from the walls themselves.  The cave
...
Config.NewRoom({
	Id = 4110,
	Name = "The Golden Cave",
	Desc = [[   You are standing in what appears to be the middle of the western
...
Config.NewRoom({
	Id = 4111,
	Name = "The Hole",
	Desc = [[   You find yourself standing in a small alcove as the tunnel comes to
...
Config.NewRoom({
	Id = 4112,
	Name = "The Tunnel",
	Desc = [[   The walls of this small tunnel are almost completely covered in a
...
Config.NewRoom({
	Id = 4113,
	Name = "The Tunnel",
	Desc = [[   The tunnel in which you currently stand is fairly wide (very wide
...
Config.NewRoom({
	Id = 4114,
	Name = "The Passage",
	Desc = [[   This north-south passageway looks to be a natural creation, except
...
Config.NewRoom({
	Id = 4115,
	Name = "The Golden Cave",
	Desc = [[   You are standing in what appears to be the south-west corner of
this large cavern.  The cave is lit by the eerie, soft, golden light
which looks to be emanating from the walls themselves.  The cave
...
Config.NewRoom({
	...
	Desc = [[   You find yourself in a small passage ending.  It is quite dark in here.
...
Config.NewRoom({
	Id = 4117,
	Name = "The Passage",
	Desc = [[   You find yourself in quite an ordinary passageway which leads north
...
Config.NewRoom({
	...
	Desc = [[   You are currently standing in a narrow passageway that does not seem
...
Config.NewRoom({
	Id = 4119,
	Name = "The Cave",
	Desc = [[   This rather large cave is surprisingly very well lit.  There are
...
Config.NewRoom({
	Id = 4121,
	Name = "The Passage",
	Desc = [[   You stand in a fairly normal passage, slightly wider than is
...
Config.NewRoom({
	Id = 4122,
	Name = "The Secret Tunnel",
	Desc = [[   You stand in a very unnatural hallway, about ten feet across and
...
Config.NewRoom({
	...
	Desc = [[   You stand in a small chamber that you never would have thought
...
Config.NewRoom({
	Id = 4126,
	Name = "The Passage",
	Desc = [[   You are at the end of a narrow passage which leads away from
...
Config.NewRoom({
	Id = 4127,
	Name = "The Crawlway",
	Desc = [[   You are in a very narrow crawlway.  To back out of it, you would have
