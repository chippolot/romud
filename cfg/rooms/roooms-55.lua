Config.NewRoom({
	...
	Desc = [[   You find yourself in an entrance foyer to the Dancing Daemon Inn.
...
Config.NewRoom({
	...
	Desc = [[   You are now standing in the reception of New Thalos.  A huge mahogany
...
Config.NewRoom({
	...
	Desc = [[   A huge circling wet-bar takes up most of the east end of the Daemon.  An
...
Config.NewRoom({
	Id = 5404,
	Name = "The Medina",
	Desc = [[   You stand on the Medina, on the larger open areas in New Thalos.
...
Config.NewRoom({
	Id = 5405,
	Name = "The Medina",
	Desc = [[   You are walking along a wide open expanse of road connecting
...
Config.NewRoom({
	...
	Desc = [[   The large square of markets fills your vision.  Strange sights and
...
Config.NewRoom({
	...
	Desc = [[   You are standing in the center of Market Square, the famous square
...
Config.NewRoom({
	...
	Desc = [[   In this corner of the market some of the largest warriors in the land
...
Config.NewRoom({
	...
	Desc = [[   This area of the market seems relatively quiet, save the high pitch
...
Config.NewRoom({
	...
	Desc = [[   This area of the square seems a bit more subdued than the rest.
...
Config.NewRoom({
	...
	Desc = [[   People pass by talking to each other, or rest their weary bones on this
...
Config.NewRoom({
	...
	Desc = [[   You see before you the expanse of the Great Eastern Desert.
...
Config.NewRoom({
	...
	Desc = [[   Walking over the bridge you see the rushing waters of the River
...
Config.NewRoom({
	...
	Desc = [[   Two large stone towers rise up to greet you with the massive iron
...
Config.NewRoom({
	...
	Desc = [[   This corner of the market contains some of the most civilized folk
...
Config.NewRoom({
	...
	Desc = [[   You stand in one of the most heavily used parts of town.  To the north
...
Config.NewRoom({
	...
	Desc = [[   Pandemonium.  Chaos.  Madness.  A few other choice words come to mind
...
Config.NewRoom({
	...
	Desc = [[   You stand in the market of New Thalos, the gem of the desert.  The
...
Config.NewRoom({
	Id = 5419,
	Name = "Sultan's Walk",
	Desc = [[   This cobblestone road aides your journey through town.  Traveling north
...
Config.NewRoom({
	Id = 5420,
	Name = "Sultan's Walk",
	Desc = [[   This part of the road travels between one of the sturdy walls of
...
Config.NewRoom({
	Id = 5421,
	Name = "Sultan's Walk",
	Desc = [[   The road here between the Palace and the Dancing Daemon Inn seems well
...
Config.NewRoom({
	Id = 5422,
	Name = "Sultan's Walk",
	Desc = [[   The main road north from the square continues here, surrounded
...
Config.NewRoom({
	...
	Desc = [[   Two large stone towers rise up to greet you with a massive iron
...
Config.NewRoom({
	...
	Desc = [[   Two large stone towers embedded in the wall loom over you.  The
...
Config.NewRoom({
	...
	Desc = [[   This is the main road traveling though the city.  To the south you
...
Config.NewRoom({
	Id = 5426,
	Name = "West Main Street",
	Desc = [[   A foreman stands stand here watching over two construction workers
...
Config.NewRoom({
	Id = 5427,
	Name = "West Main Street",
	Desc = [[   You are strolling on the street between the bank and general store.
...
Config.NewRoom({
	...
	Desc = [[   Here on East Main, you smell the odor of freshly slaughtered meat
...
Config.NewRoom({
	Id = 5429,
	Name = "East Main Street",
	Desc = [[   You are on East Main Street.  To the North is the beginning
...
Config.NewRoom({
	Id = 5430,
	Name = "East Main Street",
	Desc = [[   As you walk by the mercenary guild a cold chill causes you to shiver
...
Config.NewRoom({
	Id = 5431,
	Name = "East Main Street",
	Desc = [[   The Main street through eastern New Thalos begins here and heads
...
Config.NewRoom({
	...
	Desc = [[   Two large stone towers imbedded in the wall loom over you.  The
...
Config.NewRoom({
	...
	Desc = [[   Nothing in your life has prepared you for the odor which fills your
...
Config.NewRoom({
	...
	Desc = [[   This is the warehouse district of New Thalos.  Strong men walk back
...
Config.NewRoom({
	Id = 5435,
	Name = "West Ishtar Drive",
	Desc = [[   A few men walk by almost pushing you out of the way as they go about
...
Config.NewRoom({
	Id = 5436,
	Name = "West Ishtar Drive",
	Desc = [[   The cobblestone road is moist here, the trail of water heading down to
...
Config.NewRoom({
	Id = 5437,
	Name = "West Ishtar Drive",
	Desc = [[   A cool breeze blows up off the river chilling the sweat otherwise
...
Config.NewRoom({
	...
	Desc = [[   Loud hammering and the sound of red hot iron cooling in water reaches 
...
Config.NewRoom({
	Id = 5439,
	Name = "East Ishtar Drive",
	Desc = [[   The wide road bordering the south of town continues to the east west
...
Config.NewRoom({
	Id = 5440,
	Name = "East Ishtar Drive",
	Desc = [[   Small clumps of hay strewn about the ground alerts you to the fact
...
Config.NewRoom({
	Id = 5441,
	Name = "East Ishtar Drive",
	Desc = [[   Even in broad daylight, you can hardly see into the back alley
...
Config.NewRoom({
	Id = 5442,
	Name = "East Ishtar Drive",
	Desc = [[   Your highly acute sense of smell reports you have reached the
...
Config.NewRoom({
	Id = 5443,
	Name = "East Ishtar Drive",
	Desc = [[   The sound of squawking gulls and the smell of rotting fish gives you
...
Config.NewRoom({
	Id = 5444,
	Name = "The Boat Ramp",
	Desc = [[   This sloped slab of stone allows easy passage to and from the River
Ishtar.  Boats are moored to the docks here awaiting their masters to
return from the warehouses and the pubs.  The waters of the River Ishtar
lap at your feet to the south and Ishtar Drive is to the north.]],
	Exits = {
...
Config.NewRoom({
	Id = 5445,
	Name = "West Casbah",
	Desc = [[   The air takes on a somber note as you stand before the entrance to the
...
Config.NewRoom({
	Id = 5446,
	Name = "West Casbah",
	Desc = [[   You have almost reached the end of the Avenue in this direction, the 
...
Config.NewRoom({
	Id = 5447,
	Name = "The Casbah",
	Desc = [[   The wall of the Palace curves south from here, a darkened alley runs
...
Config.NewRoom({
	Id = 5448,
	Name = "The Casbah",
	Desc = [[   As you travel down the road towards towards the City Hall you look up
...
Config.NewRoom({
	Id = 5449,
	Name = "The Casbah",
	Desc = [[   The cobblestone pavement runs along the north wall here.  South of you
...
Config.NewRoom({
	Id = 5450,
	Name = "The Casbah",
	Desc = [[   The activity here is only slightly less than chaotic.  Young boys run
...
Config.NewRoom({
	Id = 5451,
	Name = "The Casbah",
	Desc = [[   Walking along the cobblestone path you feel secure with the walls of
...
Config.NewRoom({
	Id = 5452,
	Name = "The Casbah",
	Desc = [[   The din of the guilds assaults your senses as you reach this
...
Config.NewRoom({
	Id = 5453,
	Name = "The Casbah",
	Desc = [[   You walk between the solid stone wall of the city and that of the
...
Config.NewRoom({
	Id = 5454,
	Name = "The Casbah",
	Desc = [[   You have almost reached the end of the Avenue in this direction.
...
Config.NewRoom({
	Id = 5455,
	Name = "The Casbah",
	Desc = [[   The Avenue ends here, turning south to become Kali Row.  Traveling in
...
Config.NewRoom({
	Id = 5456,
	Name = "Kali Row",
	Desc = [[   This is a small, newly added section of the town.  The city's Library
...
Config.NewRoom({
	Id = 5457,
	Name = "Kali Row",
	Desc = [[   The short Row ends abruptly here at the entrance to the dance
hall of New Thalos.
...
Config.NewRoom({
	Id = 5459,
	Name = "Alley",
	Desc = [[   This is a dark alley running between the Palace and City Hall.  Not a
...
Config.NewRoom({
	...
	Desc = [[   This Row is a hive of activity second only to the actual Market 
...
Config.NewRoom({
	Id = 5462,
	Name = "Guildsman's Row",
	Desc = [[   The guilds continue here, to the west is the Weavers' Guild, and
...
Config.NewRoom({
	Id = 5463,
	Name = "Guildsman's Row",
	Desc = [[   Only one guild offers its door to this stretch of the Row, the Tanners'
...
Config.NewRoom({
	Id = 5464,
	Name = "Guildsman's Row",
	Desc = [[   After the guilds were built the people of the city used some of the
...
Config.NewRoom({
	Id = 5465,
	Name = "Guildsman's Row",
	Desc = [[   This small cramped road is worn with travel as apprentices to the
...
Config.NewRoom({
	Id = 5466,
	Name = "Alley",
	Desc = [[   Even with your light you cannot seem to penetrate the magical cloak of
...
Config.NewRoom({
	Id = 5470,
	Name = "Alley",
	Desc = [[   This is a tiny corner in the alley.  The temple walls are north and
...
Config.NewRoom({
	Id = 5471,
	Name = "Alley",
	Desc = [[   This is a dead end to the tiny alley.  There is an unusual amount of
...
Config.NewRoom({
	Id = 5472,
	Name = "Alley",
	Desc = [[   You are in a tiny ally between the temple and the bank.  You hear
...
Config.NewRoom({
	Id = 5473,
	Name = "Alley",
	Desc = [[   You are on a small alley between the repair shop and the general
...
Config.NewRoom({
	Id = 5474,
	Name = "Alley",
	Desc = [[   This is a small corner in the alley behind the warehouses and the guild
...
Config.NewRoom({
	Id = 5476,
	Name = "Underground",
	Desc = [[   You are in a small underground passage beneath the city.  You see a
...
Config.NewRoom({
	Id = 5479,
	Name = "Underground",
	Desc = [[   The alley turns again here and heads south and west.  You notice a
...
Config.NewRoom({
	Id = 5480,
	Name = "Underground",
	Desc = [[   The passage ends here and you hear some low chanting from the west.
...
Config.NewRoom({
	Id = 5482,
	Name = "Underground",
	Desc = [[   The small passage heads north and east from here.  You here the sounds
...
Config.NewRoom({
	Id = 5483,
	Name = "Underground",
	Desc = [[   The tunnel continues you west and east.  Hopefully you have a good sense
of direction.]],
	Exits = {
		east = 5493,
		west = 5482
...
Config.NewRoom({
	Id = 5484,
	Name = "River Ishtar",
	Desc = [[   High above you on the top of the city wall guards look down to see if
...
Config.NewRoom({
	Id = 5485,
	Name = "River Ishtar",
	Desc = [[   The gentle flow of the river carries you eastward, looking up you
...
Config.NewRoom({
	Id = 5486,
	Name = "River Ishtar",
	Desc = [[   You hear your voice echo as you float under the bridge above.  The
...
Config.NewRoom({
	Id = 5487,
	Name = "River Ishtar",
	Desc = [[   This part of the river seems alive with activity.  Boats moored to
...
Config.NewRoom({
	Id = 5488,
	Name = "River Ishtar",
	Desc = [[   The river flows through a huge iron grating from the wilderness
...
Config.NewRoom({
	Id = 5489,
	Name = "A Dark Passage",
	Desc = [[   You seem to have stumbled into a small hand made passage.  The wall
...
Config.NewRoom({
	Id = 5490,
	Name = "A Dark Passage",
	Desc = [[   The small passage continues east and west from here.  Again you
...
Config.NewRoom({
	Id = 5492,
	Name = "A Dark Passage",
	Desc = [[   The small passage ends here for no apparent reason.  Looking around
...
Config.NewRoom({
	...
	Desc = [[   You walk down the staircase into the silent inner sanctum.  Here sits
...
Config.NewRoom({
	...
	Desc = [[   You have entered the chamber of the most holy man in New Thalos.  The
...
Config.NewRoom({
	Id = 5506,
	Name = "By The Altar",
	Desc = [[   You are by the temple altar in the northern end of Temple of New
...
Config.NewRoom({
	...
	Desc = [[   Rows and rows of uncut cloth lie about waiting to be hemed up
...
Config.NewRoom({
	...
	Desc = [[   You have entered a busy workshop filled with people running amok
...
Config.NewRoom({
	...
	Desc = [[   The temple continues here, but not on such a grand scale.  The place
...
Config.NewRoom({
	Id = 5510,
	Name = "Inside The Temple",
	Desc = [[   Huge marble pillars rise on either side of you and grab hold of
...
Config.NewRoom({
	...
	Desc = [[   This room is new to the temple, it was created during the hard times
...
Config.NewRoom({
	...
	Desc = [[   Four large stone statues reside in the museum.  They were constructed
...
Config.NewRoom({
	...
	Desc = [[   This hall pales in comparison to that of the main hall, but is
...
Config.NewRoom({
	...
	Desc = [[   You stand before the entrance way to the Temple of New Thalos.  Two
...
Config.NewRoom({
	Id = 5515,
	Name = "Ahkeem's Stuff",
	Desc = [[   You step into a shop swirling with smoke.  Ahkeem seems to have a
...
Config.NewRoom({
	Id = 5516,
	Name = "Vera's Veggies",
	Desc = [[   This is a busy place.  Customers shuffle around, bartering for lower
...
Config.NewRoom({
	...
	Desc = [[   You walk into a cold room whose only feature is an old wooden
...
Config.NewRoom({
	...
	Desc = [[   You enter a small tiled courtyard with a small fountain in the middle.
...
Config.NewRoom({
	...
	Desc = [[   You are startled by the lavishness of this place.  From what you
...
Config.NewRoom({
	Id = 5521,
	Name = "Temple Square",
	Desc = [[   You are standing on the meeting grounds of those with holy
...
Config.NewRoom({
	Id = 5522,
	Name = "The Bank",
	Desc = [[   You stand in a large building decorated with black marble and red
...
Config.NewRoom({
	Id = 5523,
	Name = "The Butchery",
	Desc = [[   This shop has the aroma of freshly slaughterd beasts.  You feel right
...
Config.NewRoom({
	...
	Desc = [[   The first thing you notice as you walk into this spacious shop is
...
Config.NewRoom({
	...
	Desc = [[   You enter a shop crowded with bookshelves and clutterd with scrolls.
...
Config.NewRoom({
	...
	Desc = [[   The entrance hall is a small poor lighted room.  It would seem its
...
Config.NewRoom({
	...
	Desc = [[   One of the most popular shops in New Thalos, this shop is always a
...
Config.NewRoom({
	...
	Desc = [[   The new found wealth of this beautiful city is apearant in the exotic
...
Config.NewRoom({
	Id = 5530,
	Name = "Abdul's Armour",
	Desc = [[   The sound of hammering metal grows louder as you enter the armoury.
...
Config.NewRoom({
	...
	Desc = [[   This guild is frowned upon by most of the population of New Thalos,
...
Config.NewRoom({
	...
	Desc = [[   This small, dark room has a single torch mounted in the wall for
...
Config.NewRoom({
	Id = 5534,
	Name = "The Whet Stone",
	Desc = [[   Very large men with very large swords drink beer from very large mugs.
...
Config.NewRoom({
	...
	Desc = [[   This is a wide expanse of grass filled with dummies, punching bags
...
Config.NewRoom({
	...
	Desc = [[   A small stand has been set up here, showing the shopkeep's humble
...
Config.NewRoom({
	...
	Desc = [[   You can't help but shiver as you look at the selection of vicious
...
Config.NewRoom({
	...
	Desc = [[   You are standing on a thick oriental rug surrounded on all sides by
...
Config.NewRoom({
	Id = 5539,
	Name = "Smuggler's Inn",
	Desc = [[   You are inside a filthy inn, that seemingly has been cleaned in
...
Config.NewRoom({
	...
	Desc = [[   A draft chills your bones as you enter, though you see no open
...
Config.NewRoom({
	Id = 5541,
	Name = "The Warehouse",
	Desc = [[   You are standing in a large room used to store merchandise made in the
...
Config.NewRoom({
	Id = 5542,
	Name = "The Warehouse",
	Desc = [[   Men walk to and fro counting crates and writing down their findings.
...
Config.NewRoom({
	Id = 5543,
	Name = "The Shipwright",
	Desc = [[   The wood under you feet creaks from years of being soaked in saltwater.
...
Config.NewRoom({
	...
	Desc = [[   The walls are covered with paper sketchings of hull designs.  This room
...
Config.NewRoom({
	Id = 5545,
	Name = "The Forge",
	Desc = [[   Very much like the weaponsmith this man deals in the molding of metal.
...
Config.NewRoom({
	...
	Desc = [[   Nothing you wouldn't expect is here.  Several stalls hold the
...
Config.NewRoom({
	...
	Desc = [[   This is a hidden yard known to only a few people in New Thalos.  Here
...
Config.NewRoom({
	Id = 5548,
	Name = "The Dump",
	Desc = [[   This is the place where the people of the city dump their trash.  Due
...
Config.NewRoom({
	...
	Desc = [[   You stand in the top of an old stone tower.  Along the walls hundreds
...
Config.NewRoom({
	Id = 5550,
	Name = "The Hay Loft",
	Desc = [[   Not as big as the ones you see on farms in the country, this hay loft
...
Config.NewRoom({
	...
	Desc = [[   Nowhere have you seen such an obscene display of wealth then in this 
...
Config.NewRoom({
	Id = 5552,
	Name = "The Library",
	Desc = [[   This building holds the vast collection of books and documents
...
Config.NewRoom({
	Id = 5553,
	Name = "The Dance Hall",
	Desc = [[   You seem to have missed a huge party.  The janitors are here cleaning
...
Config.NewRoom({
	Id = 5554,
	Name = "The Jail",
	Desc = [[   You are in jail.  For some reason, someone feels that you've screwed
...
Config.NewRoom({
	Id = 5555,
	Name = "City Hall",
	Desc = [[   You stand inside the administrative head of the city.  Here the
...
Config.NewRoom({
	...
	Desc = [[   The walls in this room are covered with pegs that hold various types
...
Config.NewRoom({
	...
	Desc = [[   There is no doubt that the Dwarves here know what they're doing.  They
...
Config.NewRoom({
	...
	Desc = [[   You stand inside the southern of the two main guard houses.  The
...
Config.NewRoom({
	...
	Desc = [[   You stand before a magnificantly crafted gate wrought in solid gold.
...
Config.NewRoom({
	...
	Desc = [[   You stand on one of the four towers guarding the city.  The view from
...
Config.NewRoom({
	Id = 5561,
	Name = "The Guard House",
	Desc = [[   You stand inside the northern of the two main guard houses.  Strong
...
Config.NewRoom({
	Id = 5562,
	Name = "The Kitchen",
	Desc = [[   Your footsteps echo off the stone tiles of the kitchen.  On the south
...
Config.NewRoom({
	...
	Desc = [[   You stand on one of the four towers guarding the city.  To the north
...
Config.NewRoom({
	Id = 5564,
	Name = "A Hall",
	Desc = [[   You are at the eastern end of the southern hallway.  A small servants'
...
Config.NewRoom({
	...
	Desc = [[   You first notice the pungent smell of freshly tanned leather goods as
...
Config.NewRoom({
	Id = 5566,
	Name = "A Hall",
	Desc = [[   You have come to the eastern end of the northern hallway.  The only
...
Config.NewRoom({
	...
	Desc = [[   As you step into this room you seem to leave the material plane.
...
Config.NewRoom({
	...
	Desc = [[   You stand outside the gate of New Thalos.  The city lies to the south,
...
Config.NewRoom({
	...
	Desc = [[   You stand outside the protective walls of the city.  The massive iron
...
Config.NewRoom({
	...
	Desc = [[   You stand outside the city walls, the iron gate to the east.  The city
...
Config.NewRoom({
	...
	Desc = [[   You are in a small clearing outside the east wall of the city.  The
...
Config.NewRoom({
	...
	Desc = [[   A long oaken table, coverd with silverware, plates, and a table cloth
...
Config.NewRoom({
	Id = 5573,
	Name = "A Hall",
	Desc = [[   You stand at a T-crossing in the long hallways.  There are two large
...
Config.NewRoom({
	Id = 5574,
	Name = "A Hall",
	Desc = [[   You stand at an intersection of the hallways.  Wooden corridors
...
Config.NewRoom({
	Id = 5575,
	Name = "A Hall",
	Desc = [[   You have come to a T-crossing on the hallways.  The wooden corridors
...
Config.NewRoom({
	...
	Desc = [[   You enter a cold damp room with bare roughly hewn stone walls.
...
Config.NewRoom({
	Id = 5577,
	Name = "A Guest Room",
	Desc = [[   This is a simple room used for visiting nobles.  A small dresser stands
...
Config.NewRoom({
	Id = 5578,
	Name = "A Hall",
	Desc = [[   The long hall continues here with a wooden door in the south wall.  On
...
Config.NewRoom({
	...
	Desc = [[   You have entered the Sultan's private gardens.  A light sweat breaks
...
Config.NewRoom({
	Id = 5580,
	Name = "A Hall",
	Desc = [[   The long stretch of hallway continues east and west from here.  The
...
Config.NewRoom({
	...
	Desc = [[   You are standing in the Sultan's tribute to the finer virtues.
...
Config.NewRoom({
	Id = 5582,
	Name = "A Guest Room",
	Desc = [[   This is another room made up for visiting nobles.  There is a dresser
...
Config.NewRoom({
	Id = 5583,
	Name = "A Hall",
	Desc = [[   You have reached the western end of the southern hallway.  The only
...
Config.NewRoom({
	...
	Desc = [[   Walking through the gardens you come across a small white wooden
...
Config.NewRoom({
	Id = 5585,
	Name = "A Hall",
	Desc = [[   This is the western end of the northern hallway.  Two doors are set
...
Config.NewRoom({
	Id = 5586,
	Name = "The Guard Room",
	Desc = [[   You stand in a barren chamber lined with nothing but cots and
...
Config.NewRoom({
	Id = 5587,
	Name = "The Guard Room",
	Desc = [[   This is living quarters for the guards of the palace.  Barren compared
...
Config.NewRoom({
	Id = 5588,
	Name = "The Harem",
	Desc = [[   This is the room where the Sultan keeps the beautiful women of his
...
Config.NewRoom({
	Id = 5589,
	Name = "A Small room",
	Desc = [[   This is secret chamber allowing the Sultan direct access to his harem
...
Config.NewRoom({
	...
	Desc = [[   You stand in the throne room of the mighty Sultan of New Thalos.  Guards
...
Config.NewRoom({
	...
	Desc = [[   You have somhow managed to gain access to the treaure vault of the
...
Config.NewRoom({
	...
	Desc = [[   Climbing down the old wooden ladder you enter a small cave like
...
Config.NewRoom({
	...
	Desc = [[   You stand in a roughly hewn stone tunnel with cells to the north and
...
Config.NewRoom({
	...
	Desc = [[   This room seems more like a lair than a cell.  Small bits of hay lie
...
Config.NewRoom({
	Id = 5606,
	Name = "A Hall",
	Desc = [[   You stand in a large cedar wood hall leading east and west.  On the
...
Config.NewRoom({
	Id = 5608,
	Name = "A Path Through The Mountains",
	Desc = [[   Travel is hard and slow as you almost have to climb around large
...
Config.NewRoom({
	...
	Desc = [[   The ground drops off below down to a rushing river.  A small rope
...
Config.NewRoom({
	...
	Desc = [[   The small rope bridge shudders under your weight as you make your
...
Config.NewRoom({
	...
	Desc = [[   You are walking around a small ledge overlooking a large valley
...
Config.NewRoom({
	Id = 5612,
	Name = "A Path Through The Mountains",
	Desc = [[   You are walking through a rock strewn path deep within the mountains
...
Config.NewRoom({
	...
	Desc = [[   You stand on the eastern edge of the eastern mountains.  The high
...
Config.NewRoom({
	...
	Desc = [[   The path curves down the face of the mountain allowing you to
...
Config.NewRoom({
	Id = 5616,
	Name = "A Rocky Trail",
	Desc = [[   The faint sound of a flowing river reaches your ears from the south and 
...
Config.NewRoom({
	Id = 5619,
	Name = "On A Road",
	Desc = [[   You stand on a well maintained road leading east towards New Thalos
...
Config.NewRoom({
	...
	Desc = [[   You are at the headwaters of what is oft called the darkest river
...
Config.NewRoom({
	Id = 5621,
	Name = "River Ishtar",
	Desc = [[   The river calms a bit after being thrashed in the interior of
...
Config.NewRoom({
	Id = 5623,
	Name = "River Ishtar",
	Desc = [[   The river begins its decent out of the mountains now and continues
...
Config.NewRoom({
	Id = 5624,
	Name = "River Ishtar",
	Desc = [[   The river flows under the wall of the city to the east and stretches
...
Config.NewRoom({
	Id = 5625,
	Name = "River Ishtar",
	Desc = [[   The river flows out from the city down a long winding gully towards
...
Config.NewRoom({
	Id = 5626,
	Name = "River Ishtar",
	Desc = [[   The river continues its descent down the lowlands flowing ever so
...
Config.NewRoom({
	Id = 5627,
	Name = "River Ishtar",
	Desc = [[   Small animals and herd animals can be heard in the distance, though 
...
Config.NewRoom({
	Id = 5628,
	Name = "The Edge Of The Ravine",
	Desc = [[  You stand at the edge of a really long drop down.  A small rope
...
Config.NewRoom({
	Id = 5629,
	Name = "A Path Through The Mountains",
	Desc = [[   The narrow path makes its way through the mountains east
...
Config.NewRoom({
	Id = 5630,
	Name = "A Path Through The Mountains",
	Desc = [[   A large boulder suddenly decides it wants to occupy the same space
...
Config.NewRoom({
	Id = 5634,
	Name = "On A Road",
	Desc = [[   The road bends here toward the riverbank giving access to
...
Config.NewRoom({
	...
	Desc = [[   The river flows south through a valley in the mountains.  You can see
...
Config.NewRoom({
	Id = 5636,
	Name = "The River Of Lost Souls",
	Desc = [[   The river flows south in the southern end of this wide valley.  The
...
Config.NewRoom({
	Id = 5637,
	Name = "The River Of Lost Souls",
	Desc = [[   The river begins to speed up as it cascades down this mountain
...
Config.NewRoom({
	Id = 5638,
	Name = "The River Of Lost Souls",
	Desc = [[   The river rapidly flows down this crack in the side of the mountain
...
Config.NewRoom({
	Id = 5639,
	Name = "The River Of Lost Souls",
	Desc = [[   The river seems to calm a bit as the crevase widens lessens
...
Config.NewRoom({
	...
	Desc = [[   The waters of the river crash down upon a rock and split into
...
Config.NewRoom({
	Id = 5641,
	Name = "The River Of Lost Souls",
	Desc = [[   The river continues north and south from here through a water
eroded valley.]],
	Exits = {
		north = 5640,
		south = 5642
...
Config.NewRoom({
	Id = 5644,
	Name = "The River Of Lost Souls",
	Desc = [[   The river makes a sharp bend here and heads south into a large
...
Config.NewRoom({
	Id = 5645,
	Name = "River Ishtar",
	Desc = [[   The river widens here, no longer bounded by rock, and flows east
towards a plain.]],
	Exits = {
		east = 5646,
		west = 5623
...
Config.NewRoom({
	Id = 5646,
	Name = "River Ishtar",
	Desc = [[   The river continues here east to east.  There is a landing area to
...
Config.NewRoom({
	Id = 5647,
	Name = "River Ishtar",
	Desc = [[   The river meanders through the foothills of the eastern mountains.
...
Config.NewRoom({
	Id = 5648,
	Name = "River Ishtar",
	Desc = [[   The river continues its journey eastward flowing through the
...
Config.NewRoom({
	Id = 5650,
	Name = "River Ishtar",
	Desc = [[   The river slows as it widens and meanders through the lowlands.  A
...
Config.NewRoom({
	...
	Desc = [[   You are walking over rocks and stones through the mountains between 
...
Config.NewRoom({
	...
	Desc = [[   A large natural spring issues forth from the heart of the mountain
...
Config.NewRoom({
	...
	Desc = [[   The river flows down the mountain through a large crevasse to the west
...
Config.NewRoom({
	Id = 5663,
	Name = "On The Dark River",
	Desc = [[   The walls of this canyon tower overhead as the river continues east
and west from here.]],
	Exits = {
		east = 5662,
		west = 5664
...
Config.NewRoom({
	Id = 5664,
	Name = "On The Dark River",
	Desc = [[   The walls of rock around you slowly shrink to ground level as the river 
...
Config.NewRoom({
	Id = 5665,
	Name = "On The Dark River",
	Desc = [[   The river continues east and west from here out of the foothills
...
Config.NewRoom({
	Id = 5666,
	Name = "On The Dark River",
	Desc = [[   The river, following a low spot in the foothills, bends and twists.
...
Config.NewRoom({
	Id = 5668,
	Name = "On The Dark River",
	Desc = [[   The river flows west from here into the heart of the mountain and
...
Config.NewRoom({
	Id = 5669,
	Name = "On The Dark River",
	Desc = [[   You can barely make out what is ahead of you as the river flows
...
Config.NewRoom({
	Id = 5670,
	Name = "On The Dark River",
	Desc = [[   The river slowly flows west towards the heart of the mountain.  There
...
Config.NewRoom({
	Id = 5671,
	Name = "On The Dark River",
	Desc = [[   The river continues east and west from here flowing south of a dark
...
Config.NewRoom({
	Id = 5672,
	Name = "On The Dark River",
	Desc = [[   The river flows south through a narrowing part of the passage as it
...
Config.NewRoom({
	...
	Desc = [[   You clamber out of the water up onto this narrow ledge to see if
...
Config.NewRoom({
	Id = 5682,
	Name = "On The Plains",
	Desc = [[   You stand on an open expanse of grass extending in all directions.
...
Config.NewRoom({
	Id = 5683,
	Name = "On The Plains",
	Desc = [[   You stand on an open field of grass.  The forest to the north is
...
Config.NewRoom({
	...
	Desc = [[   You stand at the edge of a huge forest.  The line of trees
...
Config.NewRoom({
	Id = 5685,
	Name = "River Ishtar",
	Desc = [[   The river broadens even more here and the waters become murky.
...
Config.NewRoom({
	...
	Desc = [[   This is where the river empties out into the Dragon Sea.  The backrush
...
Config.NewRoom({
	Id = 5687,
	Name = "The Dragon Sea",
	Desc = [[   You are on the clear blue seas of the Dragon Sea.  Water extends
...
Config.NewRoom({
	Id = 5688,
	Name = "The Dragon Sea",
	Desc = [[   The Dragon Sea comes up along the shore here.  The deep blue waters
...
Config.NewRoom({
	Id = 5691,
	Name = "On A Road",
	Desc = [[   The people of New Thalos take great pride in the services their
...
Config.NewRoom({
	Id = 5692,
	Name = "On A Road",
	Desc = [[   You walk along a well used road with beautiful scenery.  To the north
...
Config.NewRoom({
	Id = 5693,
	Name = "On A Road",
	Desc = [[   The Dragon Sea can be seen to the east now spreading out to unknown
...
Config.NewRoom({
	Id = 5694,
	Name = "On A Road",
	Desc = [[   This is the man land route through the land.  Merchants can bring
...
Config.NewRoom({
	Id = 5695,
	Name = "Near The Shore",
	Desc = [[   The road ends here turning into a small dirt path leading down the
...
Config.NewRoom({
	Id = 5696,
	Name = "On A Dock",
	Desc = [[   You stand on a simple wooden dock that acts as an extension of the
...
Config.NewRoom({
	Id = 5697,
	Name = "The Dragon Sea",
	Desc = [[   You are on the clear blue seas of the Dragon Sea.  Water extends in
...
Config.NewRoom({
	Id = 5698,
	Name = "The Dragon Sea",
	Desc = [[   The ocean spreads out in all directions rolling gently.  In the
...
Config.NewRoom({
	Id = 5699,
	Name = "Under The dock",
	Desc = [[   You are swiming underneath the dock.  You can see the four wooden
...
Config.NewRoom({
	...
	Desc = [[   Blood swirls around in the water as the Ixitxachitl devours the 
