...
Config.NewRoom({
	Id = 3102,
	Name = "The Promenade",
	Desc = [[   The river gently flows westwards just north of here.  The promenade
...
Config.NewRoom({
	...
	Desc = [[   You are at the Concourse.  The city wall is just east and a small
...
Config.NewRoom({
	Id = 3107,
	Name = "Park Cafe",
	Desc = [[   You are inside Park Cafe, a very cozy place with many tables and
...
Config.NewRoom({
	...
	Desc = [[   You are in the park.  The paths lead north and west.  Westward is the
...
Config.NewRoom({
	Id = 3116,
	Name = "A Path In The Park",
	Desc = [[   You are in the park.  The paths lead north and east.  Eastward is the
...
Config.NewRoom({
	Id = 3118,
	Name = "Emerald Avenue",
	Desc = [[   You are standing on the north end of Emerald Avenue.  To the north is the
...
Config.NewRoom({
	Id = 3120,
	Name = "Emerald Avenue",
	Desc = [[   You are standing at a bend on Emerald Avenue.  The road leads north and
west.]],
	Exits = {
		north = 3118,
		west = 3134
...
Config.NewRoom({
	Id = 3126,
	Name = "Emerald Avenue",
	Desc = [[   You are on Emerald Avenue which continues north.  The Concourse is south
of here.]],
	Exits = {
		north = 3122,
		south = 3129
...
Config.NewRoom({
	Id = 3127,
	Name = "Park Road",
	Desc = [[   You are on Park Road which continues north.  The Concourse is south of
here.]],
	Exits = {
		north = 3123,
		south = 3130
...
Config.NewRoom({
	Id = 3129,
	Name = "On The Concourse",
	Desc = [[   The Concourse continues both east and west.  Emerald Avenue is north of
here.]],
	Exits = {
		north = 3126,
		east = 3130,
...
Config.NewRoom({
	Id = 3130,
	Name = "On The Concourse",
	Desc = [[   The Concourse continues both east and west.  Park Road is north of here
...
Config.NewRoom({
	Id = 3133,
	Name = "Emerald Avenue",
	Desc = [[   You are at Emerald Avenue which continues north and south.  Penny Lane leads
east from here.]],
	Exits = {
		north = 3104,
		east = 3140,
...
Config.NewRoom({
	...
	Desc = [[   The arch under the bridge is covered by seaweed about a foot above the
...
Config.NewRoom({
	Id = 3202,
	Name = "On The River",
	Desc = [[   North of here you see the miserable buildings of Poor Alley.  The
...
Config.NewRoom({
	Id = 3205,
	Name = "On The River",
	Desc = [[   You see the warehouse on the northern riverbank.  East of here you see the
