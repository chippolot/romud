Config.NewRoom({
	...
	Desc = [[   This trail leads up, up, up into the mountains.  You
...
Config.NewRoom({
	Id = 6402,
	Name = "A Mountain Trail",
	Desc = [[   You're really high up now.  You can keep going even
...
Config.NewRoom({
	Id = 6403,
	Name = "A Mountain Trail",
	Desc = [[   Wispy clouds are beginning to surround you now, and
...
Config.NewRoom({
	...
	Desc = [[   The peak of this mountain is another couple hundred
...
Config.NewRoom({
	...
	Desc = [[   The trail leads down into the valley, where, by judging
...
Config.NewRoom({
	Id = 6406,
	Name = "In The Valley",
	Desc = [[   The ground has taken on the texture of dirt on the top,
...
Config.NewRoom({
	Id = 6407,
	Name = "In A Clearing",
	Desc = [[   You come to a small clearing now, after walking for several
...
Config.NewRoom({
	Id = 6408,
	Name = "A Stairwell",
	Desc = [[   This small room is the top of a stairwell leading down
...
Config.NewRoom({
	Id = 6409,
	Name = "A Linen Closet",
	Desc = [[   This small room holds many types of linen on shelves 
...
Config.NewRoom({
	Id = 6410,
	Name = "A Corridor",
	Desc = [[   This is only a clean corridor, that leads back to the 
...
Config.NewRoom({
	Id = 6411,
	Name = "A Bathroom",
	Desc = [[   This is some sort of bathroom, like you've never seen
...
Config.NewRoom({
	...
	Desc = [[   This is an opulent room, decorated in silks and gold.
...
Config.NewRoom({
	Id = 6413,
	Name = "The Library",
	Desc = [[   A great mages' library is contained on this floor of 
...
Config.NewRoom({
	Id = 6414,
	Name = "The Stairwell",
	Desc = [[   This stairwell continues up and down, and there is
a door to the west.]],
	Exits = {
		west = 6413,
		up = 6408,
...
Config.NewRoom({
	Id = 6415,
	Name = "A Hidden Hall",
	Desc = [[   This is a small hidden hall with a secret entrance to the
...
Config.NewRoom({
	Id = 6416,
	Name = "A Stairwell",
	Desc = [[   This stairwell continues up and down, and there is a door
...
Config.NewRoom({
	Id = 6418,
	Name = "A Hallway",
	Desc = [[   This hall runs through the tower.  There's more hall to
...
Config.NewRoom({
	...
	Desc = [[   This seems to be a small servant's bedroom, sparsely
...
Config.NewRoom({
	Id = 6421,
	Name = "A Hallway",
	Desc = [[   This hallway continues to the east, and has a door to 
...
Config.NewRoom({
	Id = 6423,
	Name = "The Stairwell",
	Desc = [[   This stairwell leads up and down, and there is a big
...
Config.NewRoom({
	...
	Desc = [[   This is a large dining hall, with a long table that runs
...
Config.NewRoom({
	...
	Desc = [[   This is a well-stocked kitchen, the larders still fresh
...
Config.NewRoom({
	Id = 6426,
	Name = "The Stairwell",
	Desc = [[   The stairwell leads up and down here, and there is a hall
...
Config.NewRoom({
	Id = 6427,
	Name = "A Hall",
	Desc = [[   This area of the tower seems dank and oppressive.  The
...
Config.NewRoom({
	Id = 6428,
	Name = "A Hall",
	Desc = [[   This is the northern end of the hall.  There are cells to
...
Config.NewRoom({
	Id = 6429,
	Name = "A Hall",
	Desc = [[   This is the southern end of the hall.  There are cells to
your right and left, empty and awaiting occupants.]],
	Exits = {
		north = 6427
	}
...
Config.NewRoom({
	Id = 6430,
	Name = "A Stairwell",
	Desc = [[   The stairwell continues up and down here.  A large room
...
Config.NewRoom({
	...
	Desc = [[   A small desk here is cluttered with magically preserved
...
Config.NewRoom({
	Id = 6432,
	Name = "The Stairwell",
	Desc = [[   The stairs go up and down here, and there is a room to the
west...]],
	Exits = {
		west = 6433,
		up = 6430,
...
Config.NewRoom({
	Id = 6433,
	Name = "A Sitting Room",
	Desc = [[   This is a simply furnished room, with chairs all about.
...
Config.NewRoom({
	Id = 6434,
	Name = "The Stairwell",
	Desc = [[    This is where the stairwell finally ends.  There is a hall
to your west.]],
	Exits = {
		west = 6435,
		up = 6432
...
Config.NewRoom({
	Id = 6435,
	Name = "A Hallway",
	Desc = [[   This small hallway on the former 'ground floor' ran north-
...
Config.NewRoom({
	...
	Desc = [[   This is a grand chamber with giant double-doors to the
...
Config.NewRoom({
	Id = 6437,
	Name = "The Doorway",
	Desc = [[   This was the entrance to the tower.  Now lava has blocked
...
Config.NewRoom({
	Id = 6438,
	Name = "The Hallway",
	Desc = [[    This is the southern part of the hallway.  There is 
...
Config.NewRoom({
	Id = 6439,
	Name = "The Stairs",
	Desc = [[   Stairs lead down here into the tower's basement, or you
...
Config.NewRoom({
	Id = 6440,
	Name = "The Stairs",
	Desc = [[   Stairs lead up here to the main level, or you can go east
...
Config.NewRoom({
	Id = 6441,
	Name = "An Alcove",
	Desc = [[   This alcove leads into a huge room to your north, and
...
Config.NewRoom({
	Id = 6442,
	Name = "The Laboratory",
	Desc = [[   This laboratory has lots of stuff in it.  Beakers,
...
Config.NewRoom({
	Id = 6443,
	Name = "The Stairs",
	Desc = [[   Stairs lead down here to the second level of the basement,
...
Config.NewRoom({
	Id = 6444,
	Name = "The Stairs",
	Desc = [[   Stairs lead up here to the first level of the basement, or
...
Config.NewRoom({
	...
	Desc = [[   This room is darkly lit by a giant glowing pentagram in
...
Config.NewRoom({
	...
	Desc = [[   The small god entrapped by the wizard looks at you with
