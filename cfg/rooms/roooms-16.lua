Config.NewRoom({
	...
	Desc = [[   You find yourself on a small road leading away from the edge
...
Config.NewRoom({
	Id = 1502,
	Name = "A Long Road",
	Desc = [[   You stand here in spiritual emptiness, beginning a long and dangerous
...
Config.NewRoom({
	Id = 1503,
	Name = "A Long Road",
	Desc = [[   You stop for a moment, screaming in frustration.  Surely it was that one
...
Config.NewRoom({
	Id = 1504,
	Name = "A Long Road",
	Desc = [[   The road clears, the fog and pain of the first few steps left behind
...
Config.NewRoom({
	Id = 1505,
	Name = "A Long Road",
	Desc = [[   Looking ahead, you can see that the path you have been following will
...
Config.NewRoom({
	...
	Desc = [[   It is here finally that decisions must be made.  The first one that
...
Config.NewRoom({
	...
	Desc = [[   Even the darkest have a place on the road to the truth.  It is in this
...
Config.NewRoom({
	Id = 1508,
	Name = "Shahadah",
	Desc = [[   It was written once, on an ancient parchment in a curious and flowing
...
Config.NewRoom({
	Id = 1509,
	Name = "Earthly Evil",
	Desc = [[   Whatever it carries, that rage converts into a weapon.  Wrath supplies
...
Config.NewRoom({
	Id = 1510,
	Name = "Misguidance",
	Desc = [[   Some have been brought here not for what they did, but what they
...
Config.NewRoom({
	Id = 1511,
	Name = "Temptation",
	Desc = [[   Old tales tell of a conversation between the devil and the Prophet
...
Config.NewRoom({
	Id = 1512,
	Name = "Hypocrisy",
	Desc = [[   He called the populace to strict religious purity, rigidly enforcing
...
Config.NewRoom({
	Id = 1513,
	Name = "Hate",
	Desc = [[   There is little in life much easier, and truthfully, little that is a
...
Config.NewRoom({
	...
	Desc = [[   Some evils are tangible, solid, so evident that they spit you right in
...
Config.NewRoom({
	Id = 1515,
	Name = "The Fall",
	Desc = [[   In the beginning, he was the best, the most beautiful of all the angels,
...
Config.NewRoom({
	Id = 1516,
	Name = "Temptation",
	Desc = [[   Temptation is the IF, the wondering, the second-guessing, the "I will
...
Config.NewRoom({
	Id = 1517,
	Name = "The Last Day",
	Desc = [[   The din of a great battle shakes these halls, the moans of the earth
...
Config.NewRoom({
	Id = 1518,
	Name = "Flame",
	Desc = [[   Undescribable horror and pain, a blackness drowned out only by the
...
Config.NewRoom({
	Id = 1519,
	Name = "Earthly Light",
	Desc = [[   To slip into evil is easy, but walking this path is the hardest of
...
Config.NewRoom({
	...
	Desc = [[   Many believed that the Prophet would never die, but when the stark
...
Config.NewRoom({
	Id = 1521,
	Name = "The Light of the Rashidun",
	Desc = [[   The first Caliphs were chosen by consultation with a noble council
...
Config.NewRoom({
	Id = 1522,
	Name = "The Light of the Rashidun",
	Desc = [[   Every majestic and happy tale must end, usually all too soon, and thus
...
Config.NewRoom({
	Id = 1523,
	Name = "The Light of the Rashidun",
	Desc = [[   The end of the Rashidun was the beginning of Schism.  The memories
...
Config.NewRoom({
	...
	Desc = [[   Behold, Allah is the Provider, the most Generous.  He would not suffer
...
Config.NewRoom({
	Id = 1525,
	Name = "Creation",
	Desc = [[   In the creation of the heavens and the earth, and in the alternation of
...
Config.NewRoom({
	Id = 1526,
	Name = "Revelation",
	Desc = [[   The Angel Gabriel came to him and said: "Read!"  He replied: "But I
...
Config.NewRoom({
	Id = 1527,
	Name = "Conversion",
	Desc = [[   Unbelievers, I do not worship what you worship, nor do you worship
...
Config.NewRoom({
	Id = 1528,
	Name = "Deliverance",
	Desc = [[   The balance had been made, the soul placed in readiness, and the final
...
Config.NewRoom({
	Id = 1529,
	Name = "Repentance",
	Desc = [[   God forgives those who commit evil in ignorance, for He is all-knowing
...
Config.NewRoom({
	Id = 1530,
	Name = "Pilgrimage",
	Desc = [[   It is incumbent upon all Muslims to make the pilgrimage to Mecca once
...
Config.NewRoom({
	Id = 1531,
	Name = "Intercession",
	Desc = [[   It is written that no one may intercede with God on behalf of another.
...
Config.NewRoom({
	...
	Desc = [[   You have traveled the righteous path, and you have faced the examples
...
Config.NewRoom({
	Id = 1533,
	Name = "The Upper Reaches",
	Desc = [[   When the records of men's deeds are laid open, and heaven is stripped
...
Config.NewRoom({
	Id = 1534,
	Name = "The Upper Reaches",
	Desc = [[   You have traveled the righteous path, and your own journey has
...
Config.NewRoom({
	...
	Desc = [[   The last of the darkness lies behind you; only the straight path
...
Config.NewRoom({
	...
	Desc = [[   The Compassionate, the Merciful, Sovereign of the Day of Judgment!
...
Config.NewRoom({
	Id = 1539,
	Name = "Progression",
	Desc = [[   Were We worn out by the First Creation?  Yet they are in doubt about
...
Config.NewRoom({
	Id = 1540,
	Name = "Judgment",
	Desc = [[   Undoubtedly the shortest path is the straightest one.  Only one more
...
Config.NewRoom({
	...
	Desc = [[   You have come at last to the resting place of the most holy.  Startling
