Config.NewRoom({
	...
	Desc = [[   Before you, the grove of shadows lies.  Giant grey trees are all that
...
Config.NewRoom({
	...
	Desc = [[   You are inside the shadow grove.  Giant trees seem to glare at you
...
Config.NewRoom({
	Id = 2504,
	Name = "The Shadow Grove",
	Desc = [[   You are inside the shadow grove.  Giant trees seem the glare at you
from all sides.  The shadowy mist obscures most of your vision.  Strange
sounds of moaning and growling come from all directions.
   All exits lead into shadows, you are very confused.]],
	Exits = {
...
Config.NewRoom({
	...
	Desc = [[   You are in a small clearing in the shadow grove.  There is charred grass
...
Config.NewRoom({
	...
	Desc = [[   You have reached the entrance to the High Tower of Sorcery.  The
...
Config.NewRoom({
	Id = 2515,
	Name = "Common Room",
	Desc = [[   You are in the common room.  There are many apprentice warlocks here
...
Config.NewRoom({
	Id = 2516,
	Name = "The Hallway",
	Desc = [[   You are in a long hallway, it seems rather unremarkable.  The
...
Config.NewRoom({
	Id = 2518,
	Name = "A Dark Hallway",
	Desc = [[    You are in a dark hallway.  It is apparent that this area is seldom
...
Config.NewRoom({
	...
	Desc = [[   You are in the mages' tavern.  The air is smokey and filled with the
...
Config.NewRoom({
	Id = 2520,
	Name = "The Magic Shop",
	Desc = [[   You are in the High Tower's store of magic.  This place sells all
...
Config.NewRoom({
	Id = 2521,
	Name = "The Kitchen",
	Desc = [[   You are in a small kitchen.  All the usual kitchen type utensils and
...
Config.NewRoom({
	...
	Desc = [[   You are below the trapdoor.  It is very dark and dusty here, very
...
Config.NewRoom({
	...
	Desc = [[   You are in a damp intersection of what seems to be the basement of
...
Config.NewRoom({
	Id = 2524,
	Name = "A Dark Passage",
	Desc = [[   You are at the end of a dark passage which ends in a stout wooden door.
...
Config.NewRoom({
	Id = 2525,
	Name = "A Dark Passage",
	Desc = [[   You are at the end of a dark passage.  A half opened door is to the
...
Config.NewRoom({
	...
	Desc = [[   You are at the edge of a stagnant pool of water.  The smell here is quite
...
Config.NewRoom({
	Id = 2527,
	Name = "A Dark Passage",
	Desc = [[   You are in a dark passage, which comes to an abrupt stop at what appears
...
Config.NewRoom({
	Id = 2528,
	Name = "A Dark Cell",
	Desc = [[   You are in a dark cell.  Straw and dirt cover the floors here, it is
...
Config.NewRoom({
	...
	Desc = [[   You are in the Jailor's office.  It is rather messy here.  Judging
...
Config.NewRoom({
	...
	Desc = [[   As you dive beneath the putrid waters, you feel a strong tug and a
...
Config.NewRoom({
	Id = 2531,
	Name = "The Hallway",
	Desc = [[   You are in a long hallway leading east and west.  The walls emit a faint
...
Config.NewRoom({
	...
	Desc = [[   You are at a bend in the hallway.  The walls emit a faint magical glow
...
Config.NewRoom({
	Id = 2535,
	Name = "A Hallway",
	Desc = [[   You are in a long hallway leading north and south.  The walls emit a
...
Config.NewRoom({
	...
	Desc = [[   You are in the chamber of the tower guardians.  It is rather sparsely
...
Config.NewRoom({
	...
	Desc = [[   You are in a small guest bedroom.  A small cot is in one corner, and a
...
Config.NewRoom({
	Id = 2538,
	Name = "A Guest Bedroom",
	Desc = [[   You are in a comfortable looking bedroom.  A small globe of magical
...
Config.NewRoom({
	Id = 2539,
	Name = "A hallway",
	Desc = [[   You are in a long hallway leading from the south.  The walls emit a
faint magical glow which provides enough light to see by.
...
Config.NewRoom({
	Id = 2540,
	Name = "The Burnt Room",
	Desc = [[   You are in what looks to have once been a guest bed room.  The walls
...
Config.NewRoom({
	Id = 2541,
	Name = "A Hallway",
	Desc = [[   You are in a long hallway leading west from here.  The walls emit a
...
Config.NewRoom({
	Id = 2542,
	Name = "A Cul De Sac",
	Desc = [[   You are in a small cul de sac.  A window to the east is letting in
...
Config.NewRoom({
	...
	Desc = [[   You are in the barracks of the apprentice magic users.  Here and there,
...
Config.NewRoom({
	Id = 2544,
	Name = "A Hallway",
	Desc = [[   You are in a long hallway leading east and west.  The walls emit a
faint magical glow which provides enough light to see by.
...
Config.NewRoom({
	...
	Desc = [[   You are in a small workshop.  Writing implements and parchment are
...
Config.NewRoom({
	Id = 2550,
	Name = "A Classroom",
	Desc = [[   You are in a large classroom filled with bored looking students of the
...
Config.NewRoom({
	...
	Desc = [[   You are in an empty classroom.  Some strange sigils are written on a
...
Config.NewRoom({
	...
	Desc = [[   You are in a small amphitheater.  Rows of comfortable looking chairs
...
Config.NewRoom({
	...
	Desc = [[   You are in a large training room.  It is filled with battle scared
...
Config.NewRoom({
	Id = 2562,
	Name = "A Dueling Room",
	Desc = [[   You are in a large room used for duals arcane.  The walls, ceiling and
...
Config.NewRoom({
	...
	Desc = [[   You are in a large comfortable looking lounge.  Off duty spell teachers
...
Config.NewRoom({
	Id = 2566,
	Name = "A Bedroom",
	Desc = [[   You are in a large, plush bedroom.  The owner is obviously someone of
...
Config.NewRoom({
	Id = 2568,
	Name = "The Study",
	Desc = [[   You are in a small, well kept study.  Ancient tomes are on shelves
...
Config.NewRoom({
	...
	Desc = [[   You are at the end of a long hallway.  The walls emit a faint magical
...
Config.NewRoom({
	...
	Desc = [[   You are atop a stairway.  The halls here look quite a bit less used than
...
Config.NewRoom({
	Id = 2571,
	Name = "A Hallway",
	Desc = [[   You are in a long hallway stretching east and west.  The walls here emit
...
Config.NewRoom({
	Id = 2572,
	Name = "A Small Office",
	Desc = [[   You are in a small office.  It looks like a calligrapher's
...
Config.NewRoom({
	...
	Desc = [[   You are in the workshop of the tower's master scribe.  Many half
...
Config.NewRoom({
	Id = 2576,
	Name = "A Store Room",
	Desc = [[   You are in a small dark store room.  A few common items are stacked
...
Config.NewRoom({
	Id = 2577,
	Name = "A Bend In The Hallway",
	Desc = [[   You are at a bend in the long hallway.  The walls emit a faint magical
...
Config.NewRoom({
	Id = 2580,
	Name = "A Store Room",
	Desc = [[   You are in a large store room.  Bins of ores, minerals and
...
Config.NewRoom({
	...
	Desc = [[   You are in a very hot room.  Against one wall is a large forge, magical
...
Config.NewRoom({
	...
	Desc = [[   You have entered the Master Enchanter's chamber.  Upon all the walls
...
Config.NewRoom({
	Id = 2584,
	Name = "A Bend In The Hallway",
	Desc = [[   You are at a bend in a long hallway.  The walls emit a faint magical
glow which provides enough light to see by.
...
Config.NewRoom({
	Id = 2587,
	Name = "A Laboratory",
	Desc = [[   You are in a small laboratory.  Many strange instruments, vials, bottles
...
Config.NewRoom({
	...
	Desc = [[   You are in the workroom of The Mad Alchemist.  Bubbling braziers,
...
Config.NewRoom({
	...
	Desc = [[   You are in a large room with a five pointed star etched into the
...
Config.NewRoom({
	...
	Desc = [[   You feel a stomach twisting sensation as you enter the energy field.
...
Config.NewRoom({
	Id = 2595,
	Name = "An Empty Room",
	Desc = [[   You are in an empty room.  It is both quiet and comfortable here, it
...
Config.NewRoom({
	...
	Desc = [[   You are in the chambers of the tower's Master of Charm.  Some straw
...
Config.NewRoom({
	...
	Desc = [[   You are in the animal pens.  Many caged animals are here looking unhappy.
...
Config.NewRoom({
	...
	Desc = [[   You are at the end of a long north-south hallway.  The walls emit
...
Config.NewRoom({
	Id = 2600,
	Name = "Atop The Stairway",
	Desc = [[   You are atop the stairway to the upper levels of the high tower.  The
...
Config.NewRoom({
	Id = 2602,
	Name = "A Store Room",
	Desc = [[   You are in a large store room.  Raw materials are neatly bundled and
...
Config.NewRoom({
	...
	Desc = [[   You are in the chambers of the Master Spellbinder.  Unlike other work
...
Config.NewRoom({
	...
	Desc = [[   You have discovered the cache of the Master Spellbinder.  There are
...
Config.NewRoom({
	...
	Desc = [[   You are in the golem master's workshop.  A few unfinished looking humanoid
...
Config.NewRoom({
	Id = 2611,
	Name = "A Store Room",
	Desc = [[   You are in a small store room.  Large chunks of clay, stone, wood and
...
Config.NewRoom({
	...
	Desc = [[   You are in the golem chamber.  Golems made of every imaginable material
...
Config.NewRoom({
	...
	Desc = [[   You are in the chamber of the Master of Illusions.  The walls here
...
Config.NewRoom({
	Id = 2619,
	Name = "A Bedroom",
	Desc = [[   You are in the bedroom of the Master of Illusions.  Strange looking
...
Config.NewRoom({
	...
	Desc = [[   You are in a meditation chamber.  It is very silent here, in fact
...
Config.NewRoom({
	Id = 2622,
	Name = "A Bend In The Hallway",
	Desc = [[   You are at a bend in the long hallway.  The walls emit a faint
magical glow which provides enough light to see by.
...
Config.NewRoom({
	Id = 2624,
	Name = "A Dark Room",
	Desc = [[   You are in a large dark room.  The air here seems quite stale, and a
...
Config.NewRoom({
	Id = 2625,
	Name = "A Dark Room",
	Desc = [[   You are in a large dark room.  The stench here makes you gag and retch.
...
Config.NewRoom({
	...
	Desc = [[   You are in the lair of the evil Necromancer.  Undead minions of all
...
Config.NewRoom({
	Id = 2629,
	Name = "The End Of The Hallway",
	Desc = [[   You are at the end of a long hallway.  The walls here glow with a faint
...
Config.NewRoom({
	Id = 2630,
	Name = "A Corridor",
	Desc = [[   You are at the east end of a long corridor.  Obsidian walls
...
Config.NewRoom({
	Id = 2631,
	Name = "A Corridor",
	Desc = [[   You are in a long corridor.  Obsidian walls engraved with ancient runes
...
Config.NewRoom({
	...
	Desc = [[   You are at a bend in the long corridor.  Obsidian walls engraved with
...
Config.NewRoom({
	Id = 2633,
	Name = "A Corridor",
	Desc = [[   You are in a long corridor leading north and south.  Obsidian walls
...
Config.NewRoom({
	...
	Desc = [[   You are at an intersection in the corridor.  The obsidian walled halls
...
Config.NewRoom({
	Id = 2635,
	Name = "A Corridor",
	Desc = [[   You are at the end of a long corridor.  Obsidian walls engraved with
...
Config.NewRoom({
	...
	Desc = [[   You are in the scrying chamber of the high tower of sorcerery.  It is
...
Config.NewRoom({
	Id = 2637,
	Name = "A Corridor",
	Desc = [[   You have reached an end in the long corridor.  Obsidian walls engraved
...
Config.NewRoom({
	...
	Desc = [[   You are in the entrance to the great library of magic.  A giant desk is
...
Config.NewRoom({
	Id = 2639,
	Name = "In The Library",
	Desc = [[   You are in the great library of magic.  A strong musty smell permeates
...
Config.NewRoom({
	...
	Desc = [[   You are in the great library of magic.  The shelves seem uncomfortably
...
Config.NewRoom({
	...
	Desc = [[   You are in a small room completely devoid of furnishings.  The only thing
...
Config.NewRoom({
	...
	Desc = [[   You are at the end of a long corridor.  The obsidian walls come to an
...
Config.NewRoom({
	...
	Desc = [[   You feel a slight tingle as you pass through the archway, as if the living
...
Config.NewRoom({
	Id = 2651,
	Name = "An Intersection",
	Desc = [[   You are at an intersection of several hallways.  You feel as if strange
...
Config.NewRoom({
	...
	Desc = [[   You are in a grey tiled hallway leading north and south.  Dim balls
...
Config.NewRoom({
	...
	Desc = [[   You are in the antechamber of the Master Magician of the Grey Light.
...
Config.NewRoom({
	...
	Desc = [[   A feeling of tranquility comes over you as you enter the main chamber
...
Config.NewRoom({
	Id = 2656,
	Name = "The Study",
	Desc = [[   You are in a large study.  Shelves filled with many books or arcane
...
Config.NewRoom({
	Id = 2657,
	Name = "A Closet",
	Desc = [[   You are in a small closet.  It is filled with many cloaks, and some
other apparel.]],
	Exits = {
		west = 2655
	}
...
Config.NewRoom({
	Id = 2658,
	Name = "A Bedroom",
	Desc = [[   You are in the bedroom of the Master Magician of Neutrality.
...
Config.NewRoom({
	Id = 2659,
	Name = "A Dark Hallway",
	Desc = [[   You are in a long dark hallway leading east and west.  Not much can
...
Config.NewRoom({
	Id = 2661,
	Name = "The End Of The Hallway",
	Desc = [[   You are at the end of a long dark hallway.  The darkness here is almost
...
Config.NewRoom({
	...
	Desc = [[   You are in a vast chamber.  The walls fade into darkness, leaving you
...
Config.NewRoom({
	...
	Desc = [[   You are in an ill lit chamber.  Instruments of torture hang from a rack
...
Config.NewRoom({
	...
	Desc = [[   You are in a small dark chamber.  Upon the walls are glowing sigils of
...
Config.NewRoom({
	...
	Desc = [[   You are in a long well lit hallway leading east and west.  The walls
...
Config.NewRoom({
	Id = 2668,
	Name = "An Antechamber",
	Desc = [[   You are in a small antechamber.  It is well lit here, though the source
...
Config.NewRoom({
	...
	Desc = [[   You are in a vast chamber, its walls floor and ceiling are of an
...
Config.NewRoom({
	Id = 2671,
	Name = "The Meditation Chamber",
	Desc = [[   You are in a small meditation chamber.  White silk cushions are
...
Config.NewRoom({
	Id = 2672,
	Name = "A Study",
	Desc = [[   You are in a spacious study.  It is extremely tidy here, to an almost
...
Config.NewRoom({
	Id = 2673,
	Name = "A Closet",
	Desc = [[   You are in a small closet.  Cloaks and vests hang from hooks in
...
Config.NewRoom({
	Id = 2674,
	Name = "A Wide Hallway",
	Desc = [[   You are in a large hallway, wide enough to accommodate several people
...
Config.NewRoom({
	...
	Desc = [[   You are at the entrance to the audience chamber of the Grand Master of
...
Config.NewRoom({
	...
	Desc = [[   You are in a large chamber.  Small bolts of energy leap from wall to
...
Config.NewRoom({
	...
	Desc = [[   You are in a plush dressing room.  Fine garments of many styles and some
...
Config.NewRoom({
	Id = 2680,
	Name = "The Library",
	Desc = [[   You are in a small cosy looking library.  A few well made books sit atop
...
Config.NewRoom({
	Id = 2681,
	Name = "The Altar",
	Desc = [[   You are in a small chapel designed around a beautifully crafted golden
...
Config.NewRoom({
	Id = 2684,
	Name = "In The Light",
	Desc = [[   You seem to be floating in a magical energy field, though you cannot
